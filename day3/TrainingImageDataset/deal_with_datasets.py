...
# 原始图像数据集路径（包含各类子目录）
dataset_dir = r'/Users/weirdprincess/PycharmProjects/dataset/Images'

# 训练集和验证集输出路径
train_dir = r'/Users/weirdprincess/PycharmProjects/dataset/image2/train'
val_dir = r'/Users/weirdprincess/PycharmProjects/dataset/image2/val'
